# Mobile Output Guidelines

Assume many users read outfit advice on a phone.
...
- Avoid displaying the theory model unless asked.
- If the request is urgent, give one best outfit plus one backup.
